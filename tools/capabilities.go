...
var toolDomain = map[string]string{
	...
	"search_context":              CapabilityMemory,
	"record_fact":                 CapabilityMemory,
	...
	"classify_learning_candidate": CapabilityMemory,
	...
	"set_schedule_subscription":       CapabilityComms,
...
var toolEffect = map[string]string{
	...
	"classify_learning_candidate":     ToolEffectWrite,
	...
	"set_schedule_subscription":       ToolEffectWrite,
